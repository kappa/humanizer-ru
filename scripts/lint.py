...
def self_test():
    ...
    # 13 срабатывает только на полной фигуре: должен быть второй член контраста
